...
def extract_images(html_content):
    """Extract all images, including the one in the 'mp-itn' section."""
    # Regex to find all <img> tags and their src attributes
    ...
    # Process <img> tags
    for img in img_tags:
        full_img_url = f"https:{img}" if img.startswith("//") else img
